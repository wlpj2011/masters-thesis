\chapter{Main Statements}	%Chapter title
...
For $n=2$ highly ramified representations, the methods displayed here fail due to only specifying a representation up to its behaviour on $\varpi^l$ for some $l > 1$, but not defining it on $\varpi$ like for tamely ramified representations.
